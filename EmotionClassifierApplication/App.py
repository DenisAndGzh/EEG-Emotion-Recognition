...
def upload():
    f.set(filedialog.askopenfilename(title='OpenBCI output files',
...
def predict():
    ...
    tk.Label(window, text=lable_dict[result], font=(
        "微软雅黑", 25)).place(anchor="center", x=325, y=280)
...
tk.Button(window, text="Upload and predict", width=15, height=3,
          command=upload).place(anchor="center", x=163, y=385)
tk.Button(window, text="Upload and predict", width=15, height=3,
          command=predict).place(anchor="center", x=487, y=385)
